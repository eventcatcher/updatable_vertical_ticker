...
class UpdatableVerticalTickerExamplePage extends StatefulWidget {
  const UpdatableVerticalTickerExamplePage({super.key});

  @override
  State<UpdatableVerticalTickerExamplePage> createState() =>
      _UpdatableVerticalTickerExamplePageState();
}

class _UpdatableVerticalTickerExamplePageState
    extends State<UpdatableVerticalTickerExamplePage> {
